# Metrotiles Picking Operation model
#
# This model will create a new field called factory, series, variant, size in picking operations. 
# This new field will determine where the product will be
...
class Sales(models.Model):
    ...
    attn = fields.Many2one('res.users', string="AE", store=True, default=_get_default_user)
    ...
    def compute_so_details(self):
        for rec in self:
            rec.sales_person = rec.sale_id.user_id.id
            rec.contract_client = rec.sale_id.partner_id.id
